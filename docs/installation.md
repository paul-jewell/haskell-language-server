...
Haskell-language-server is available via the haskell overlay. Follthe instructions [here](https://github.com/gentoo-haskell/gentoo-haskell) to install the overlay, then run
